...
KNOB_DETAILS = {
    ...
    'innodb_buffer_pool_size': ['integer', [1, 34359738368, 34359738368], None],
    ...
    'innodb_log_file_size': ['integer', [1048576, 5497558138, 4294967296], ['innodb_log_files_in_group']],
    ...
    'innodb_file_per_table': ['enum', ['ON', 'OFF'], None],
    'binlog_checksum': ['enum', ['NONE', 'CRC32'], None],
    'binlog_cache_size': ['integer', [4096, 34359738368, 32768], None],
    'max_binlog_cache_size': ['integer', [4096, 18446744073709551615, 2147483648], None],
    'max_binlog_size': ['integer', [4096, 1073741824, 524288000], None],
