...
def init_knobs(instance, num_more_knobs):
    ...
    KNOB_DETAILS = {
        ...
        'innodb_buffer_pool_size': ['integer', [1048576, memory_size, 672162381824]],
    ...
    EXTENDED_KNOBS = {
        ...
        'tmp_table_size': ['integer', [1024, 10737418240, 1073741824]],
        #2
        ...
        'thread_cache_size': ['integer', [0, 5120, 512]],
        #1
